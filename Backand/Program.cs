...
//CRUD FOR OBJECTS_CONSTRUCTIONS
app.MapGet("/objects_constructions", Objects_ConstructionManagers.GetAllObjects_Construction);
app.MapGet("/objects_constructions/{id}", Objects_ConstructionManagers.GetObjects_ConstructionById);
app.MapDelete("/objects_constructions/{id}", Objects_ConstructionManagers.DeleteObjects_Construction);
app.MapPost("/objects_constructions/", Objects_ConstructionManagers.CreateObjects_Construction);
app.MapPut("/objects_constructions/", Objects_ConstructionManagers.UpdateObjects_Construction);
...
//CRUD FOR USER  
app.MapGet("/user/", UserManagers.GetAllUser);
